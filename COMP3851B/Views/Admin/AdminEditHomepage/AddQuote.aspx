...
<div class="container"  style="margin-left: 280px">
    ...
    <div class="form-horizontal">
        <h2 style="text-align:center">Edit Homepage Campus</h2>
        <hr />

        <div class="form-group">
            <label>Quote</Label>
       <div class="col-md-3"> 
           <asp:TextBox ID="txtQuote" runat="server" CssClass="form-control" Width="600px" Height="102px" TextMode="MultiLine"></asp:TextBox>
        </div>
            </div>
       ...
       <div class="col-md-3"> 
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="3" DataKeyNames="quoteID" DataSourceID="QuoteDataSource"  CssClass="table table-condensed table-hover" Width="50%">
            <Columns>
