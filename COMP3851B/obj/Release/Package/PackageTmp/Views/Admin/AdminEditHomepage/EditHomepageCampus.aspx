...
<div class="container"  ">
    ...
    <div class="form-horizontal">
       ...
       <div class="col-md-3"> 
           <asp:TextBox ID="txtCampusName" runat="server" CssClass="form-control" placeholder="Campus Name"></asp:TextBox>
        </div>
            </div>
       ...
       <div class="col-md-3">
            <asp:FileUpload ID="CampusImg" CssClass="form-control" runat="server" placeholder="Campus Image" />
       </div>
        </div>
            <br /><br />
