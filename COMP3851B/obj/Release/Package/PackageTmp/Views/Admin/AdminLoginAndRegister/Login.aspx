                ...
                <div class="pr-lg-5">
                    ...
                    <div class="col-lg-5 px-lg-4">
                        ...
                        <div class="form-group mb-4">
                          ...
                          <div class="form-group mb-4">
                                <br />
                              <asp:RequiredFieldValidator ID="passValidator" runat="server" ErrorMessage="Password is required" ControlToValidate="txtPass" ForeColor="Red"></asp:RequiredFieldValidator>
