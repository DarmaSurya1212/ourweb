<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="EditGuide.aspx.cs" Inherits="COMP3851B.Views.Admin.TutorialGuide.EditGuide" ValidateRequest="false"%>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container"  style="margin-left: 280px">
        <div class="form-horizontal">
            ...
            <div id="crud">
                <asp:Button ID="btnAdd" runat="server" Text="Add" CssClass="btn btn-success" ValidationGroup="GroupAdd" OnClick="btnAdd_Click" />
                 <asp:Button ID="btnSearch" runat="server" Text="Search" Class="btn btn-secondary" style="color:white" validationGroup="GroupSearch" OnClick="btnSearch_Click"/>
