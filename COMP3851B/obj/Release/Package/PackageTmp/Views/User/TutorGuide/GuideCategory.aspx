<%@ Page Title="" Language="C#" MasterPageFile="~/Views/User/User.Master" AutoEventWireup="true" CodeBehind="GuideCategory.aspx.cs" Inherits="COMP3851B.Views.User.TutorGuide.GuideCategory" %>
                            ...
                            <AlternatingItemTemplate>
                                <div class="col-lg-3 col-md-6 col-sm-6 d-flex align-items-stretch">
                                    <div class="card content">
                                        ...
                                        <div class="card-footer">
                                    <asp:LinkButton ID="lbSearch" runat="server" CssClass="ButtonDirect" Text='<%# Bind("gdeTitle") %>' CommandName="ToGuide" CommandArgument='<%# Eval("gdeID") %>'></asp:LinkButton>
                                        </div>
                                    </div>
                                </div>
                            </AlternatingItemTemplate>
