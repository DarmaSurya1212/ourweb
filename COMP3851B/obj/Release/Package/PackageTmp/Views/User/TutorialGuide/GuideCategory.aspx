...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="margin-top:100px;">
        ...
        <div class="container">
            ...
            <asp:DataList ID="DLGde" runat="server" RepeatColumns="4" RepeatDirection="Horizontal" OnItemCommand="DLGde_ItemCommand" OnSelectedIndexChanged="DLGde_SelectedIndexChanged">
                <ItemTemplate>
                    <div class="row">
